...
HD_PWD='C:/Users/Admin/Desktop/7020/25_mdio_rw_test/prj/mdio_rw_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mdio_rw_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mdio_rw_test.tcl -notrace

...
HD_PWD='E:/FPGA/wang/7020/26_eth_arp_test/prj/eth_arp_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_arp_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth_arp_test.tcl -notrace

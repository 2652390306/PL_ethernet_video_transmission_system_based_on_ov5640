...
HD_PWD='E:/FPGA/wang/7020/26_eth_arp_test/prj/eth_arp_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_arp_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_arp_test.tcl

...
HD_PWD='C:/Users/Admin/Desktop/wang/7020/27_eth_icmp_test/prj/eth_icmp_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_icmp_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth_icmp_test.tcl -notrace

...
HD_PWD='C:/Users/Admin/Desktop/wang/7020/27_eth_icmp_test/prj/eth_icmp_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_icmp_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_icmp_test.tcl

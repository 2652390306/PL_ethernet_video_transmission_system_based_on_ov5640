...
HD_PWD='C:/Users/Admin/Desktop/wang/7020/28_eth_udp_loop/prj/eth_udp_loop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_udp_loop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth_udp_loop.tcl -notrace
